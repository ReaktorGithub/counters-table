...
const TrashIcon = ({ fill = '#9DA6B4' }: Props) => {
  return (
    <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M6 5.33333V11.3333H4.66667V5.33333H6Z" fill={fill} />
      <path d="M8.66667 5.33333V11.3333H7.33333V5.33333H8.66667Z" fill={fill} />
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
